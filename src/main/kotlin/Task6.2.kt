...
fun main() {
    ...
    for (fig in figures) {
        println("For ${fig.name} area is: ${fig.area()}, and perimetr is: ${fig.perimetr()}")
    }
}
...
class Square(var side: Double) : Shapable {
...
class Parallelogram(var side1: Double, var side2: Double, var angle: Double) : Shapable {
...
class Circle(var radius: Double) : Shapable {
...
class Triangle(var side1: Double, var side2: Double, var side3: Double) : Shapable {
